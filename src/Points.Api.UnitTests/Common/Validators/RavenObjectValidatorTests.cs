...
namespace Points.Api.UnitTests.Common.Validators
{
    ...
    public class RavenObjectValidatorTests : AutoMoqTestFixture<RavenObjectValidatorTester>
    {
        ...
        public void Setup()
        {
            var ravenObjects = new List<DataBase>
            {
                new DataBase { Id = Guido.New(), Name = "object1", UserId = "user1" },
                new DataBase { Id = Guido.New(), Name = "object2", UserId = "user2" },
                new DataBase { Id = Guido.New(), Name = "object3", UserId = "user3" }
            };
            Mocked<IDataReader>().Setup(r => r.GetAll<DataBase>()).Returns(ravenObjects);
        }
        ...
        public void TestSetup()
        {
            ...
            Mocked<IDataReader>().Setup(r => r.Get<DataBase>(It.IsAny<string>())).Returns(new DataBase());
        }
        ...
        {
            var ravenObj = new DataBase {Name = name, UserId = userId};
        ...
        {
            var ravenObj = new DataBase { Name = "object1", UserId = "user1" };
        ...
        public void ValidateAddUserIdIsInvalid()
        {
            ...
            var ravenObj = new DataBase { Name = "object4", UserId = "user4" };
            var ex = Assert.Throws<InvalidDataException>(() => Subject.ValidateAdd(ravenObj));
        ...
        {
            Mocked<IDataReader>().Setup(r => r.Get<DataBase>(It.IsAny<string>())).Returns(() => null);
            var ravenObj = new DataBase { Name = "object1", UserId = "user1" };
